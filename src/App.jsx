...
const QUOTES = [
  ...
  { text: "I'm not the most talented. I'm not the biggest. I'm not the strongest. But I will outwork you.", author: "Allen Iverson" },
  ...
  { text: "The gym is my therapy. When I'm there, nothing else matters but getting better.", author: "Kevin Garnett" },
  { text: "Don't let what you cannot do interfere with what you can do.", author: "John Wooden" },
  { text: "Every day I'm just trying to get better. Not trying to be perfect. Just better than yesterday.", author: "Stephen Curry" },
  ...
  { text: "Once I made a decision, I never thought about it again. I just went to work.", author: "Michael Jordan" },
  { text: "It's not whether you get knocked down. It's whether you get up.", author: "Vince Lombardi" }
]
function getDailyQuote() {
  // Biweekly rotation — changes every 2 weeks, 24 quotes = 48 weeks = ~1 year
  const d = new Date();
  const startOfYear = new Date(d.getFullYear(), 0, 1);
  const weekNum = Math.floor((d - startOfYear) / (7 * 24 * 60 * 60 * 1000));
  const i = Math.floor(weekNum / 2) % QUOTES.length;
  return QUOTES[i];
}
        ...
        {ex && (
          <div style={{ background: C.surface, borderRadius: 20, border: `1px solid ${C.border}`, overflow: "hidden", marginBottom: 16 }}>
            ...
            <div style={{ padding: 24 }}>
              ...
              {ex.notes && <p style={{ fontSize: 14, color: C.textMuted, lineHeight: 1.6, marginBottom: 20, background: C.bg, borderRadius: 10, padding: "12px 16px", whiteSpace: "pre-wrap" }}>{ex.notes}</p>}
                  ...
                  <div key={drillKey} style={{ background: C.surface, borderRadius: 14, border: `1px solid ${done ? C.success + "33" : ex.is_challenge ? C.challenge + "44" : C.border}`, marginBottom: 6, overflow: "hidden" }}>
                    ...
                    {open && (() => {
                      ...
                      <div style={{ padding: "0 16px 14px" }} className="fade-in">
                        ...
                        {ex.image_url && <img src={fixImgurUrl(ex.image_url)} alt="" style={{ width: "100%", borderRadius: 12, marginTop: 10, border: `1px solid ${C.border}` }} />}
                        {ex.notes && <div style={{ background: C.bg, borderRadius: 10, padding: 14, marginTop: 10, border: `1px solid ${C.border}` }}><p style={{ fontSize: 10, fontWeight: 600, color: C.textDim, letterSpacing: 1, textTransform: "uppercase", marginBottom: 4 }}>Notes</p><p style={{ color: C.textMuted, fontSize: 13, lineHeight: 1.7, whiteSpace: "pre-wrap" }}>{ex.notes}</p></div>}
